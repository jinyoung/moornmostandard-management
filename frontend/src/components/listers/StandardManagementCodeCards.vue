    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">Code</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <StandardManagementCode :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <StandardManagementCode :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import StandardManagementCode from './../StandardManagementCode.vue';

    export default {
        name: 'StandardManagementCodeManager',
        components: {
            StandardManagementCode,
        },
        props: {
            offline: Boolean
        },
        ...
        async created() {
            ...
            me.values = temp.data._embedded.codes;
