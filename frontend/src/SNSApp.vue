            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="authGrps"
                        to="/standardManagements/authGrps"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="authUsers"
                        to="/standardManagements/authUsers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="authorities"
                        to="/standardManagements/authorities"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                description: '', 
                key: 'authGrps', 
                route: '/standardManagements/authGrps',
                ImageUrl: '',
            },
            { 
                title: 'AuthUser', 
                description: '', 
                key: 'authUsers', 
                route: '/standardManagements/authUsers',
                ImageUrl: '',
            },
            { 
                title: 'Authority', 
                description: '', 
                key: 'authorities', 
                route: '/standardManagements/authorities',
                ImageUrl: '',
            },
            { 
                title: '', 
